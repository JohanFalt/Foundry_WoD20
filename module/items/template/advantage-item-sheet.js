...
export default class AdvantageItemSheet extends HandlebarsApplicationMixin(WoDItemSheetV2) {
    ...
    static PARTS = {
        ...
        stats: {
            template: 'systems/worldofdarkness/templates/items/advantage-sheet.hbs'
        }
    }
