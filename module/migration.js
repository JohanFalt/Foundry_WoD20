 ...
 */
 export const updateItem = async function(item) {
    ...
    if (_compareVersion(itemversion, "7.0.0")) {
        let itemData = foundry.utils.duplicate(item);
        ...
        if (altered) {
            if (itemData.system?.settings?.version !== undefined) {
                itemData.system.settings.version = "7.0.0";
            }
            else {
 ...
 */
 function _getVersionText(installedVersion, migrationVersion) {
    ...
    if (!patch700) {
        ...
        newfunctions += '<li>Fixed the dodge modifier</li>';
    ...
    let message = 'New version of the system has been installed. All new functions, alterations and bug fixes can be read in detail at <a href="https://github.com/JohanFalt/Foundry_WoD20/wiki/Changelog#fix-of-v73">Changelog</a>.<br /><br />';
