 ...
 */
 function getVersionText(installedVersion, migrationVersion) {
    ...
    if (newfunctions == "") {
        ...
        newfunctions += '<li>Other traits could not set a value or be cleared: <a href="https://github.com/JohanFalt/Foundry_WoD20/issues/361">#361</a></li>';        
        newfunctions += '<li>Spanish update: <a href="https://github.com/JohanFalt/Foundry_WoD20/issues/337">#337</a></li>';
        newfunctions += '<br />';
